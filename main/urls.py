...
urlpatterns = [
    ...
    #Autentificaciones
    #path("login/", views.Login_views.login_view, name="login"),
    #path("logout/", views.Logout_views.logout_view, name="logout"),
    path("registro/", views.Registro_views.registro_view, name="registro"),

    path('login/', auth_views.LoginView.as_view(template_name='Autentificar/Login_temp.html'), name='login'),
